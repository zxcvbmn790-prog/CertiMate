          ...
          <form className="space-y-5" onSubmit={handleRegister}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input type="text" name="uname" value={formData.uname} onChange={handleChange} placeholder="성함을 입력합니다" className="w-full bg-gray-50 border border-gray-100 p-4 pl-12 rounded-xl outline-none focus:border-[#3478B8] transition text-sm font-medium" required />
              </div>
            </div>
